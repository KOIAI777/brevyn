...
- 微信：`Rouget77`。添加时备注 `GitHub`，我们会邀请你加入 Brevyn 交流群。
- Bug 与功能建议：[GitHub Issues](https://github.com/KOIAI777/brevyn/issues)
- 安全问题：请使用 [GitHub Private Vulnerability Reporting](https://github.com/KOIAI777/brevyn/security/advisories/new)，不要在公开 Issue 中提交密钥、账号或私人资料。

<a href="./resources/readme/wechat-contact.jpg"><img src="./resources/readme/wechat-contact.jpg" alt="添加 Brevyn 微信 Rouget77" width="260"></a>
