export const IPC_CHANNELS = {
  ...
  threadsUpdateWorkflow: "brevyn:threads:update-workflow",
  ...
  filesParsedPreview: "brevyn:files:parsed-preview",
  ...
  filesIndexHealth: "brevyn:files:index-health",
  ...
  appUpdateFontSmoothing: "brevyn:app:update-font-smoothing",
